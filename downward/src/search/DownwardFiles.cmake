...
fast_downward_plugin(
    ...
    HELP "Exhaustive search algorithm"
    SOURCES
...
fast_downward_plugin(
    ...
    HELP "Exhaustive best-first search"
    SOURCES
...
fast_downward_plugin(
    NAME LOGGING_EAGER_SEARCH
    HELP "Eager best-first search algorithm with logging"
    SOURCES
        search_engines/logging_eager_search
    DEPENDS NULL_PRUNING_METHOD ORDERED_SET SUCCESSOR_GENERATOR
    DEPENDENCY_ONLY
)

fast_downward_plugin(
    NAME PLUGIN_LOGGING_EAGER
    HELP "Eager best-first search with logging"
    SOURCES
        search_engines/plugin_logging_eager
    DEPENDS LOGGING_EAGER_SEARCH SEARCH_COMMON
)

fast_downward_plugin(
    NAME EXPLORATIVE_OPEN_LIST
    HELP "Open list that selects the best element according to a single evaluation function"
    SOURCES
        open_lists/explorative_open_list
)
...
fast_downward_plugin(
    NAME ROBUST_OPEN_LIST
    HELP "Open list that selects the best element according to a single evaluation function"
    SOURCES
        open_lists/robust_open_list
)

fast_downward_plugin(
    NAME NTH_BEST_FIRST_OPEN_LIST
    HELP "Open list that selects the n th best element according to a single evaluation function"
    SOURCES
