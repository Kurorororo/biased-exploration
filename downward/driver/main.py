...
def main():
    ...
    for component in args.components:
        if component == "translate":
            ...
            (exitcode, continue_execution) = run_components.run_extract(args)
        elif component == "analyze":
            (exitcode, continue_execution) = run_components.run_analyze(args)
        elif component == "draw":
            (exitcode, continue_execution) = run_components.run_draw(args)
        else:
